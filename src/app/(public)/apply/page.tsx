          ...
          <form onSubmit={handleSubmit(onSubmit as any)} className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                type="text"
                {...register("full_name")}
                className="mt-1 block w-full rounded-lg border border-border bg-background px-3 py-2 text-sm outline-none focus:border-gold focus:ring-1 focus:ring-gold"
              />
              {errors.full_name && (
            ...
            <div>
              ...
              {errors.years_experience && (
                <p className="mt-1 text-xs text-destructive">{errors.years_experience.message}</p>
              )}
            </div>

            {/* Prior Teams */}
            <div>
              <label htmlFor="prior_teams" className="block text-sm font-medium">
            ...
            {/* Position Preference */}
            <div>
              <label htmlFor="position_preference" className="block text-sm font-medium">
                Position preference
              </label>
              <select
              ...
              {errors.position_preference && (
                <p className="mt-1 text-xs text-destructive">{errors.position_preference.message}</p>
              )}
            </div>
