        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2">
              <li><Link href={`${basePath}/teams/masl3`} className="text-sm opacity-80 hover:opacity-100">MASL3 Kings</Link></li>
              <li><Link href={`${basePath}/teams/futsal-l1`} className="text-sm opacity-80 hover:opacity-100">Futsal League 1</Link></li>
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2">
              <li><Link href={`${basePath}/apply`} className="text-sm opacity-80 hover:opacity-100">Apply for Tryout</Link></li>
              <li><Link href={`${basePath}/schedule`} className="text-sm opacity-80 hover:opacity-100">Full Schedule</Link></li>
              ...
              <li><Link href={`${basePath}/sign-in`} className="text-sm opacity-80 hover:opacity-100">Member Login</Link></li>
            </ul>
          </div>
        </div>
